...
const forecast = (latitude, longitude, callback) => {
    ...
    request({url, json:true}, (error, {body}) => {
        if(error){
            ...
            callback(undefined, body.daily.data[0].summary +'. Day has high temperature of '+ body.daily.data[0].temperatureHigh +' and low temperrature of '+ body.daily.data[0].temperatureLow +' It is currently ' + body.currently.temperature + ' degress out. There is a ' + body.currently.precipProbability + '% chance of rain.')
            // callback(undefined, ({
